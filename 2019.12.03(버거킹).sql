...
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (1,'서울특별시 ','강남구',201206,14142558);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (2,'서울특별시 ','강동구',160371,5824940);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (3,'서울특별시 ','강북구',102117,2764297);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (4,'서울특별시 ','강서구',236070,8221014);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (5,'서울특별시 ','관악구',205325,6098873);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (6,'서울특별시 ','광진구',139502,4949835);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (7,'서울특별시 ','구로구',162000,5264673);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (8,'서울특별시 ','금천구',91260,2531695);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (9,'서울특별시 ','노원구',188364,6697695);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (10,'서울특별시 ','도봉구',116510,3530209);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (11,'서울특별시 ','동대문구',117744,3783211);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (12,'서울특별시 ','동작구',154339,5915612);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (13,'서울특별시 ','마포구',148218,6336265);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (14,'서울특별시 ','서대문구',112716,4227723);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (15,'서울특별시 ','서초구',165674,11359238);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (16,'서울특별시 ','성동구',116243,4929924);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (17,'서울특별시 ','성북구',144303,5413273);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (18,'서울특별시 ','송파구',263839,12335849);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (19,'서울특별시 ','양천구',170083,7279487);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (20,'서울특별시 ','영등포구',156209,6241782);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (21,'서울특별시 ','용산구',86315,4942793);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (22,'서울특별시 ','은평구',172919,5452739);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (23,'서울특별시 ','종로구',50504,2353076);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (24,'서울특별시 ','중구',43810,1894195);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (25,'서울특별시 ','중랑구',139776,3888819);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (26,'인천광역시','강화군',16947,501111);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (27,'인천광역시','계양구',115930,3235988);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (28,'인천광역시','남구',145574,3938522);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (29,'인천광역시','남동구',201133,6153649);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (30,'인천광역시','동구',22908,639655);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (31,'인천광역시','부평구',190694,5686158);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (32,'인천광역시','서구',205137,6533479);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (33,'인천광역시','연수구',133014,5540970);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (34,'인천광역시','옹진군',6720,241102);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (35,'인천광역시','중구',46437,1482402);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (36,'경기도','가평군',16876,501141);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (37,'경기도','고양시',374452,13845144);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (38,'경기도','과천시',21272,1138903);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (39,'경기도','광명시',122829,4230916);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (40,'경기도','광주시',139496,4073756);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (41,'경기도','구리시',69862,2285324);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (42,'경기도','군포시',110466,3962253);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (43,'경기도','김포시',162343,5410797);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (44,'경기도','남양주시',220273,6807236);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (45,'경기도','동두천시',31416,804852);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (46,'경기도','부천시',317454,9680039);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (47,'경기도','성남시',369392,16629729);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (48,'경기도','수원시',474241,18623591);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (49,'경기도','시흥시',184930,5483020);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (50,'경기도','안산시',260155,7752638);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (51,'경기도','안성시',69552,2079882);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (52,'경기도','안양시',224858,8354813);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (53,'경기도','양주시',75420,2023709);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (54,'경기도','양평군',29678,1006632);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (55,'경기도','여주시',35202,1010290);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (56,'경기도','연천군',12952,386623);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (57,'경기도','오산시',87693,2893828);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (58,'경기도','용인시',380135,16539462);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (59,'경기도','의왕시',58695,2216488);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (60,'경기도','의정부시',148147,4157464);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (61,'경기도','이천시',81272,2879176);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (62,'경기도','파주시',169230,5586039);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (63,'경기도','평택시',186182,6356196);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (64,'경기도','포천시',57172,1438393);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (65,'경기도','하남시',91721,3348151);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (66,'경기도','화성시',320571,13424608);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (67,'강원도','강릉시',469971,1986223);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (68,'강원도','고성군',63999,224500);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (69,'강원도','동해시',7810,925233);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (70,'강원도','삼척시',27245,638838);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (71,'강원도','속초시',19358,716837);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (72,'강원도','양구군',24361,235992);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (73,'강원도','양양군',7066,200665);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (74,'강원도','영월군',6970,332504);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (75,'강원도','원주시',10315,3725573);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (76,'강원도','인제군',114751,332212);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (77,'강원도','정선군',9950,325107);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (78,'강원도','철원군',10551,418227);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (79,'강원도','춘천시',13270,2997277);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (80,'강원도','태백시',91628,487246);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (81,'강원도','평창군',14190,296735);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (82,'강원도','홍천군',10356,537900);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (83,'강원도','화천군',18077,272125);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (84,'강원도','횡성군',8315,328745);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (85,'대전광역시','대덕구',11759,1856372);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (86,'대전광역시','동구',513492,1938560);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (87,'대전광역시','서구',63060,5876253);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (88,'대전광역시','유성구',131984,5953730);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (89,'대전광역시','중구',77608,2376938);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (90,'충청북도','괴산군',9566,271894);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (91,'충청북도','단양군',7881,235306);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (92,'충청북도','보은군',7889,229385);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (93,'충청북도','영동군',12267,353206);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (94,'충청북도','옥천군',14176,394699);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (95,'충청북도','음성군',39804,1122035);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (96,'충청북도','제천시',39824,1228746);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (97,'충청북도','증평군',13522,415890);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (98,'충청북도','진천군',33260,991590);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (99,'충청북도','청주시',308558,10836096);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (100,'충청북도','충주시',67380,2075025);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (101,'충청남도','계룡시',14671,642704);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (102,'충청남도','공주시',30857,945336);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (103,'충청남도','금산군',12279,348679);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (104,'충청남도','논산시',32557,917603);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (105,'충청남도','당진시',57959,2048715);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (106,'충청남도','보령시',28942,890902);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (107,'충청남도','부여군',15891,440734);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (108,'충청남도','서산시',56097,2223965);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (109,'충청남도','서천군',12221,369742);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (110,'충청남도','아산시',120935,4649850);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (111,'충청남도','예산군',22024,618693);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (112,'충청남도','천안시',253009,9207333);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (113,'충청남도','청양군',7427,214388);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (114,'충청남도','태안군',14497,454345);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (115,'충청남도','홍성군',29479,918636);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (116,'세종특별시','세종',119289,4941608);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (117,'광주광역시','광산구',145338,4783200);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (118,'광주광역시','남구',67375,2340539);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (119,'광주광역시','동구',28388,949175);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (120,'광주광역시','북구',143316,4507653);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (121,'광주광역시','서구',102403,3613745);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (122,'전라북도','고창군',11706,341531);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (123,'전라북도','군산시',82620,2769001);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (124,'전라북도','김제시',21602,572392);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (125,'전라북도','남원시',19794,553638);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (126,'전라북도','무주군',5621,157997);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (127,'전라북도','부안군',12145,331069);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (128,'전라북도','순창군',6791,194811);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (129,'전라북도','완주군',27309,870082);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (130,'전라북도','익산시',89928,2691925);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (131,'전라북도','임실군',6549,196526);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (132,'전라북도','장수군',4910,145043);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (133,'전라북도','전주시',211757,7182213);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (134,'전라북도','정읍시',28258,792796);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (135,'전라북도','진안군',5833,171522);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (136,'전라남도','강진군',7808,232384);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (137,'전라남도','고흥군',11690,324897);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (138,'전라남도','곡성군',6815,219181);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (139,'전라남도','광양시',49570,1918051);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (140,'전라남도','구례군',6448,179726);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (141,'전라남도','나주시',34837,1092298);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (142,'전라남도','담양군',12168,370327);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (143,'전라남도','목포시',66981,1944221);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (144,'전라남도','무안군',22043,736182);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (145,'전라남도','보성군',8363,240988);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (146,'전라남도','순천시',85436,3035101);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (147,'전라남도','신안군',7353,225273);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (148,'전라남도','여수시',82338,3207348);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (149,'전라남도','영광군',12807,423868);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (150,'전라남도','영암군',16539,452004);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (151,'전라남도','완도군',9404,270842);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (152,'전라남도','장성군',12566,385941);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (153,'전라남도','장흥군',8362,244257);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (154,'전라남도','진도군',5477,163706);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (155,'전라남도','함평군',7447,218743);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (156,'전라남도','해남군',14303,393238);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (157,'전라남도','화순군',17964,508674);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (158,'대구광역시','남구',41656,1091249);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (159,'대구광역시','달서구',194034,6322009);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (160,'대구광역시','달성군',90005,2774925);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (161,'대구광역시','동구',110188,3297807);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (162,'대구광역시','북구',142367,4239629);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (163,'대구광역시','서구',55408,1319297);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (164,'대구광역시','수성구',132091,5752044);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (165,'대구광역시','중구',23693,758724);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (166,'경상북도','경산시',86189,2489071);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (167,'경상북도','경주시',83533,2816372);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (168,'경상북도','고령군',9306,254083);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (169,'경상북도','구미시',154895,5605706);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (170,'경상북도','군위군',5379,161773);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (171,'경상북도','김천시',41786,1401345);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (172,'경상북도','문경시',17486,513569);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (173,'경상북도','봉화군',6357,187261);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (174,'경상북도','상주시',22525,658714);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (175,'경상북도','성주군',11126,287905);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (176,'경상북도','안동시',43343,1391644);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (177,'경상북도','영덕군',7556,203775);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (178,'경상북도','영양군',3127,95485);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (179,'경상북도','영주시',26798,850439);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (180,'경상북도','영천시',28169,804704);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (181,'경상북도','예천군',12041,402981);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (182,'경상북도','울릉군',2907,104730);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (183,'경상북도','울진군',12787,456063);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (184,'경상북도','의성군',10404,272097);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (185,'경상북도','청도군',9833,275220);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (186,'경상북도','청송군',5073,141134);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (187,'경상북도','칠곡군',42323,1333320);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (188,'경상북도','포항시',157439,5941833);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (189,'부산광역시','강서구',47354,1683042);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (190,'부산광역시','금정구',78579,2720852);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (191,'부산광역시','기장군',51865,1701808);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (192,'부산광역시','남구',88591,3131224);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (193,'부산광역시','동구',26122,686110);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (194,'부산광역시','동래구',87743,3064044);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (195,'부산광역시','부산진구',118350,3624256);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (196,'부산광역시','북구',101508,3209206);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (197,'부산광역시','사상구',80000,2173515);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (198,'부산광역시','사하구',116566,3431638);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (199,'부산광역시','서구',33298,1003905);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (200,'부산광역시','수영구',57496,1881045);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (201,'부산광역시','연제구',67477,2296728);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (202,'부산광역시','영도구',36409,1015442);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (203,'부산광역시','중구',13053,313108);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (204,'부산광역시','해운대구',133266,5462047);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (205,'울산광역시','남구',117719,5262216);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (206,'울산광역시','동구',64886,2616021);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (207,'울산광역시','북구',78624,3551377);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (208,'울산광역시','울주군',77963,3020026);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (209,'울산광역시','중구',79616,3313178);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (210,'경상남도','거제시',94956,3614797);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (211,'경상남도','거창군',14529,444539);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (212,'경상남도','고성군',12965,359647);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (213,'경상남도','김해시',195275,6304129);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (214,'경상남도','남해군',8996,258647);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (215,'경상남도','밀양시',29119,823901);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (216,'경상남도','사천시',34927,1143659);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (217,'경상남도','산청군',7728,226962);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (218,'경상남도','양산시',122769,3873060);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (219,'경상남도','의령군',6477,191009);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (220,'경상남도','진주시',107513,3726858);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (221,'경상남도','창녕군',17100,492858);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (222,'경상남도','창원시',375231,13680887);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (223,'경상남도','통영시',35650,1005498);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (224,'경상남도','하동군',9529,281558);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (225,'경상남도','함안군',22078,660556);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (226,'경상남도','함양군',8904,254163);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (227,'경상남도','합천군',9187,270618);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (228,'제주특별자치도','제주시',157011,4803882);
Insert into TAX (ID,SIDO,SIGUNGU,PEOPLE,SAL) values (229,'제주특별자치도','서귀포시',50517,1478653);
